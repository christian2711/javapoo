...
public class Ejerc7Persona {
    ...
    public static void main(String[] args) {
        ...
        Persona perso1 = sp.crearPersona();
        Persona perso2 = sp.crearPersona();
        Persona perso3 = sp.crearPersona();
        Persona perso4 = sp.crearPersona();
